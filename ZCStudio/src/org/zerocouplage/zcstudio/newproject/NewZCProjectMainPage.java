...
//				gd.horizontalSpan = ncol - 1;
//				projectNameText.setLayoutData(gd);
//			    projectNameText.addListener(SWT.Modify, new Listener() {
//			    	
//			        public void handleEvent(Event event) {
//			        	pattern = Pattern.compile("^[a-z0-9_-.]{1,15}$");
//			    	    matcher = pattern.matcher(projectNameText.getText());
//			    		  
//			    	
//			    	        
...
//			            if(matcher.matches()) {
//			              ((NewZCProjectWizard)getWizard()).model.projectName = text;
//			              setErrorMessage(null);
//			            }else{
//			              ((NewZCProjectWizard)getWizard()).model.projectName = null;
//			              setErrorMessage("Error : nom invalide");
//			            }
//			            
//
//			          ((NewZCProjectWizard)getWizard()).model.projectName = projectNameText.getText();
//
//			          if(((NewZCProjectWizard)getWizard()).model.projectName != null)
